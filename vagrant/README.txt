...
the vagrant deploy is based on https://www.drupal.org/project/vdd

data directory needs to contain the following - this isn't commited with this project.

files and database are also added into the data directory.

We do the build process locally - so that we can then use simlinks to the local modules / libraries 


copy and paste the below and create a settings.php file
settings.php
---------
<?php
...
$sites = array(
    "{$prefix}.v3.johnson.ca" => "v3.johnson.ca",
);
